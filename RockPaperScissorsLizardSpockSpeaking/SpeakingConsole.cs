    ...
    public static class SpeakingConsole
    {
        ...
        public static void Speak(string s)
        {
            try
            {
                ...
                lock (wplayer)
                {
                    WMPLib.IWMPControls3 controls = (WMPLib.IWMPControls3)wplayer.controls;
            ...
            switch (newState)
            {
                case 8:    // MediaEnded
                    ...
                    lock (wplayer)
                    {
                        ...
                        WMPLib.IWMPMedia media = wplayer.currentMedia;
                        string source = media.sourceURL;
                        sources.Add(source);
                        playlist.removeItem(wplayer.currentMedia);
                        media = wplayer.currentMedia;
                        source = media?.sourceURL ?? "null";
                        sources.Add(source);
